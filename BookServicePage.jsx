...
const BookServicePage = ({ language }) => {
  ...
  const content = {
    ...
    fr: {
      ...
      noServices: 'Sélectionnez des services pour continuer',
  ...
  // Sample provider data (in production, fetch from API based on providerId)
  const providers = {
    1: {
      id: 1,
      ...
      description: language === 'en'
        ...
        : 'Services de plomberie professionnels pour propriétés résidentielles et commerciales. Licencié et assuré avec plus de 15 ans d\'expérience.',
      services: [
        { id: 's1', name: language === 'en' ? 'Drain Cleaning' : 'Nettoyage de drain', price: 125, duration: '1-2h', popular: true },
        { id: 's2', name: language === 'en' ? 'Faucet Repair' : 'Réparation de robinet', price: 85, duration: '1h', popular: false },
        { id: 's3', name: language === 'en' ? 'Toilet Repair' : 'Réparation de toilette', price: 95, duration: '1h', popular: true },
        { id: 's4', name: language === 'en' ? 'Water Heater Service' : 'Service chauffe-eau', price: 175, duration: '2-3h', popular: false },
        { id: 's5', name: language === 'en' ? 'Pipe Repair' : 'Réparation de tuyaux', price: 150, duration: '2h', popular: false },
    ...
    2: {
      ...
      description: language === 'en'
        ...
        : 'Électriciens licenciés offrant des services électriques résidentiels et commerciaux. La sécurité est notre priorité.',
      services: [
        ...
        { id: 'e3', name: language === 'en' ? 'Panel Upgrade' : 'Mise à niveau du panneau', price: 450, duration: '4-6h', popular: false },
        { id: 'e4', name: language === 'en' ? 'Ceiling Fan Install' : 'Installation ventilateur', price: 125, duration: '1-2h', popular: false },
        { id: 'e5', name: language === 'en' ? 'Electrical Inspection' : 'Inspection électrique', price: 150, duration: '2h', popular: false },
      ],
    },
    3: {
      id: 3,
      ...
      description: language === 'en'
        ...
        : 'Services de nettoyage professionnels pour maisons et bureaux. Produits écologiques disponibles.',
      services: [
        ...
        { id: 'c3', name: language === 'en' ? 'Move-out Cleaning' : 'Nettoyage déménagement', price: 280, duration: '5-6h', popular: false },
