...
const AuthModal = ({ isOpen, onClose, initialMode = 'login' }) => {
  ...
  const categories = [
    { id: 'healthcare', name: 'Healthcare', nameFr: 'Sante' },
    { id: 'home', name: 'Home Services', nameFr: 'Services a domicile' },
    { id: 'auto', name: 'Auto Services', nameFr: 'Services auto' },
    { id: 'beauty', name: 'Beauty & Wellness', nameFr: 'Beaute & Bien-etre' },
    { id: 'education', name: 'Education', nameFr: 'Education' },
    { id: 'legal', name: 'Legal', nameFr: 'Juridique' },
    { id: 'tech', name: 'Tech & IT', nameFr: 'Tech & TI' },
    { id: 'repairs', name: 'Repairs', nameFr: 'Reparations' },
  ];
              ...
              <div className="space-y-4">
                ...
                >
                  <div className="flex items-center">
                    <div className="w-14 h-14 bg-blue-100 rounded-full flex items-center justify-center group-hover:bg-red-100 transition-colors">
                      <Users className="text-blue-600 group-hover:text-red-600 transition-colors" size={28} />
                    </div>
                    <div className="ml-4">
                ...
                >
                  <div className="flex items-center">
                    <div className="w-14 h-14 bg-green-100 rounded-full flex items-center justify-center group-hover:bg-red-100 transition-colors">
                      <Briefcase className="text-green-600 group-hover:text-red-600 transition-colors" size={28} />
                    </div>
                    <div className="ml-4">
            ...
            {mode === 'login' && (
              <form onSubmit={handleLogin} className="space-y-4">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full py-3 bg-red-600 text-white rounded-lg font-semibold hover:bg-red-700 disabled:bg-gray-400 disabled:cursor-not-allowed transition-colors"
                >
