...
const ProviderDashboard = () => {
  ...
  const stats = {
    totalEarnings: profile?.total_earnings || user?.total_earnings || user?.earnings || 0,
    pendingEarnings: 125.5,
    totalBookings: user?.total_bookings || user?.totalBookings || 0,
    pendingBookings: 3,
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
          <div>
            ...
            <p className="text-gray-500 mt-1">{profile?.business_name || user?.business_name || user?.businessName}</p>
          </div>
          <Link
        ...
        <div className="bg-gradient-to-r from-green-500 to-emerald-600 rounded-xl p-6 mb-8 text-white">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between">
            <div>
              <h3 className="text-xl font-semibold">Your Commission Rate: 10 percent</h3>
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-xl shadow-sm">
              <div className="flex items-center justify-between p-6 border-b">
                ...
                <Link to="/provider/dashboard" className="text-blue-600 hover:underline text-sm">
                  View all
                </Link>
              </div>
