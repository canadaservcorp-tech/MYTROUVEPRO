...
const CheckoutPage = ({ language }) => {
  const { items, total, gst, qst, grandTotal, setBooking } = useCart();
  ...
  const content = {
    en: {
      ...
      platformFeeNote: 'No extra fees for seekers. Providers cover the 10 percent platform fee.',
    },
    fr: {
      checkout: 'Paiement',
      ...
      platformFeeNote: 'Aucun frais additionnel pour les clients. La plateforme prend 10 pourcent cote fournisseur.',
    },
  };
