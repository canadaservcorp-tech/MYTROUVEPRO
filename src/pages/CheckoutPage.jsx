...
import { ArrowLeft, CheckCircle, ShoppingCart, User, Mail, Phone, MapPin, Calendar, Clock, CreditCard } from 'lucide-react';

const CheckoutPage = ({ language }) => {
  const { items, total, gst, qst, grandTotal, setBooking, clearCart } = useCart();
          ...
          <div className="lg:col-span-2">
            ...
            {step === 2 && (
              <div>
                ...
                <form onSubmit={handleCompletePayment} className="bg-white rounded-xl shadow-sm p-6">
                  <h2 className="text-xl font-bold mb-6 flex items-center">
                  ...
                  >
                    {processing ? t.processing : `${t.completePayment} - $${grandTotal.toFixed(2)} CAD`}
                  </button>
                </form>
              </div>
            )}
